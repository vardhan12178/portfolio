      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-500 p-6 rounded-lg shadow-lg">
        <div className="mb-6">
          <h2 className="text-2xl font-semibold text-white">
            ...
            <span className="text-gray-200 ml-2">(Mar 2021 - Nov 2021)</span>
          </h2>
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold text-white">
            ...
            <span className="text-gray-200 ml-2">(June 2016 - Oct 2020)</span>
          </h2>
          <p className="text-gray-200 mt-2">
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-semibold text-white">
            ...
            <span className="text-gray-200 ml-2">(June 2014 - Mar 2016)</span>
          </h2>
          <p className="text-gray-200 mt-2">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-white">
            Vikas School 
            <span className="text-gray-200 ml-2">(April 2014)</span>
          </h2>
          <p className="text-gray-200 mt-2">
            S.S.C [9.5 GPA]
          </p>
